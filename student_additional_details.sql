...
CREATE TABLE `student_additional_details` (
  ...
  `additional_field_id` int DEFAULT NULL,
...
INSERT INTO `student_additional_details` VALUES (1,14401,1,'kkkkkk'),(2,26214,1,''),(3,26216,1,'TEST'),(4,29602,1,''),(5,29603,1,''),(6,29604,1,''),(7,29606,1,''),(8,29607,1,''),(9,29608,1,''),(10,29609,1,''),(11,29692,1,'Informations suppl̩mentaires-2');
...
-- Dump completed on 2023-06-11 17:16:53
