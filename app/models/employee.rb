...
has_many :subjects, through: :employees_subjects, class_name: 'Subject'
  ...
  has_one     :school_field
  has_one     :school_module
...
#  validates_presence_of :employee_category_id, :employee_number, :first_name, :employee_position_id,
  #validates_presence_of :employee_category_id, :employee_number, :first_name,
